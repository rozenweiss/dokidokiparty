/* ============================================================
   ...
   기존 matchEngine.js(순차 패치 파이프라인)는 건드리지 않고, 이 파일을 대신 import하면
   대안 알고리즘으로 교체됩니다 — 관리자 파일의 import 경로 한 줄만 바꾸면 됩니다.

   [Inference] 이 파일은 설계 제안을 코드로 옮긴 것으로, 실제 라이브 데이터(구글시트)로
   재검증되지 않았습니다. 10절(비교 검증 방법)에 따라 matchEngine.js와 나란히 두고
